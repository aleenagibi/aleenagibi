...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=500&size=15&duration=2600&pause=700&color=8B949E&center=true&vCenter=true&repeat=true&width=760&lines=%24+whoami;final-year+B.Sc.+(Hons.+Research)+Data+Science+%26+AI+%40+CHRIST+Delhi+NCR;%24+cat+mission.txt;designing+secure%2C+scalable+AI+systems+for+enterprise+use;%24+tail+-f+currently.log;building+GreenLens+%E2%80%94+a+carbon-aware+LLM+inference+router" alt="typing terminal"/>
...
Final-year AI Engineering undergraduate working across three lanes that keep intersecting: **adversarial ML research**, **production full-stack development**, and **AI security**. I authored a Best Paper Award–winning defense framework against adversarial attacks on LLMs, then went and built a Chrome extension that scans your Gmail attachments for malware — same instinct, different attack surface. Currently aiming for a master's in applied AI/ML/NLP in Germany.
...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=700&size=22&duration=2200&pause=100000&repeat=false&color=00E5FF&center=false&vCenter=true&width=420&height=32&lines=PHASE_02+%3A%3A+PAYLOAD_ANALYSIS" alt="Phase 02"/>
...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=700&size=22&duration=2200&pause=100000&repeat=false&color=FF3B3B&center=false&vCenter=true&width=460&height=32&lines=PHASE_03+%3A%3A+DEFENSE_LAYERS_DEPLOYED" alt="Phase 03"/>

| Project | What it actually does |
|---|---|
| **[cross-phase-defense-framework](https://github.com/aleenagibi/cross-phase-defense-framework)** | Prototype for my Best Paper–winning research: a multi-layered defense against adversarial attacks on LLMs, benchmarked on DistilBERT/GPT-2 against FGSM, PGD, and DeepFool attacks. |
| **[FileGuard](https://github.com/aleenagibi/FileGuard)** | Chrome extension (Manifest V3) that scans Gmail attachments against VirusTotal before you download them — inline scan buttons, batch scanning, SHA-256 hashing, rate-limit handling. |
| **[Blockchain-Based-Voting-System](https://github.com/aleenagibi/Blockchain-Based-Voting-System)** | Proof-of-Authority blockchain voting platform — HMAC-signed validator quorum, anonymous token-based ballots, coin-based one-vote enforcement. |
| **[HoneyTrap](https://github.com/aleenagibi/HoneyTrap)** | Real-time attack detection on AWS honeypot data — Random Forest + feature engineering, 91%+ accuracy. |
| **[PLIS](https://github.com/aleenagibi/PLIS)** | An AI-powered study coach that tracks what I learn, tests whether I actually learned it, and tells me what to study next. |
| **[Campus_Path_Finder](https://github.com/aleenagibi/Campus_Path_Finder)** | Interactive campus pathfinding visualizer — BFS, DFS, Dijkstra's, in a notebook game. |
